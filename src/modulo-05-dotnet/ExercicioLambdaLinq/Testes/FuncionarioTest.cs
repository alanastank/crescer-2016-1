...
namespace Testes
{
    ...
    {        
        ...
        [TestMethod]
        public void BuscaPorNenhumTurnoERetornaTodosFuncionarios()
        {
            var repositorioFuncionarios = new RepositorioFuncionarios();
            IList<Funcionario> todosFuncionarios = repositorioFuncionarios.BuscarPorTurno();

            Assert.AreEqual(11, todosFuncionarios.Count);
        }
