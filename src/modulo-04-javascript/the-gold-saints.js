...
/* Fim de funções utilitárias para aproveitar código */
  ...
  /* 1 - Escreva uma função obterDoadores que retorne o array com os cavaleiros que são doadores universais. Ignore o fator Rh do sangue.*/
...
/* 2 - Escreva uma função obterCavaleiroComMaisGolpes que retorne o cavaleiro com o maior número de golpes.*/

// function obterCavaleiroComMaisGolpes(){
//   var cavaleiroComMaisGolpes = goldSaints[0];
//   for (var i in goldSaints){
//     if(cavaleiroComMaisGolpes.golpes.length < goldSaints[i].golpes.length){
...
/* 3 - Escreva uma função obterMesesComMaisAniversarios que retorne o array com os meses do ano que têm o maior número de cavaleiros aniversariantes. Ex: obterMesesComMaisAniversarios(); => [ 'Janeiro' ]*/

/* 4 - Escreva uma função obterAlturaMedia que retorna a altura média entre os cavaleiros de ouro.
IMPORTANTE: a altura deve ser retornada em metros e de forma numérica.*/

// function obterAlturaMedia(){
//   var soma = 0;
//   for(var i in goldSaints){
//     soma += (goldSaints[i].alturaCm / 100);
//   }
//   return parseFloat((soma / 12).toFixed(2));
// }

function obterAlturaMedia(){
  var media = (goldSaints.reduce(function(acumulador, alturaAtual) {
    return acumulador + alturaAtual.alturaCm;
  }, 0)) / goldSaints.length;
  return formatarNumero(cmParaMetros(media));
}

/* 5 - Escreva uma função obterAlturaMediana que retorna a altura mediana dos cavaleiros de ouro.
IMPORTANTE: a altura deve ser retornada em metros e de forma numérica.*/
...
//     return alturas[metade];
//   }
//   else {
//     return formatarNumero((alturas[metade-1] + alturas[metade]) /2);
//   }
// }
...
/* 6 A - Escreva uma função obterPesoMedio que retorna o peso médio em kilos dos cavaleiros de ouro.
     B - Escreva uma função obterPesoMedioDoadores que retorna o peso médio em kilos dos cavaleiros que são doadores.*/

// function obterPesoMedio(doadores){
//   var soma = 0;
//   var contador = 0;
//   for(var i in goldSaints){
//     if(typeof goldSaints[i].pesoLb === 'number'){
//     contador++;
//     soma += (goldSaints[i].pesoLb);
//     }
//   }
//   return formatarNumero(lbParaKilos(soma / contador));
// }
//
...
//   var doadoresComPeso = [];
//   for(var i in goldSaints){
//     if(goldSaints[i].tipoSanguineo === 'O' && typeof goldSaints[i].pesoLb === 'number'){
//       doadoresComPeso.push(goldSaints[i]);
//     }
//   }
//   for(var i in doadoresComPeso){
//     soma += (doadoresComPeso[i].pesoLb);
//   }
//   return formatarNumero(lbParaKilos(soma / doadoresComPeso.length));
// }
...
/* 7 - Escreva uma função obterIMC que retorna um array com todos índices de massa corporal (IMC) dos cavaleiros com peso registrado.*/

// function obterIMC(){
//   var indicesMassaCorporal = [];
//   var calculo = 0;
//   for(var i in goldSaints){
//     if(typeof goldSaints[i].pesoLb === 'number'){
//       calculo = (goldSaints[i].pesoLb * 0.453592) / Math.pow((goldSaints[i].alturaCm / 100),2);
//       indicesMassaCorporal.push(parseFloat((calculo).toFixed(2)));
//     }
//   }
//   return indicesMassaCorporal;
// }
...
/* 8 - Escreva uma função obterSobrepeso que retorna um array com os cavaleiros que estão acima de peso.*/

// function obterSobrepeso(){
//   var cavaleirosComSobrepeso = [];
//   var calculoIMC = 0;
//   for(var i in goldSaints){
//     calculoIMC = (goldSaints[i].pesoLb * 0.453592) / Math.pow((goldSaints[i].alturaCm / 100),2)
//     if(typeof goldSaints[i].pesoLb === 'number' && calculoIMC >= 25 && calculoIMC <= 29.9){
